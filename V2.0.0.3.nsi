...
N52:	   
ifFileExists "$INSTDIR\User-TheLostVillage.*k3" "Y53" "N53"
...
N53:	   
ifFileExists "$INSTDIR\TheVilla.*k3" "Y54" "N54"
...
N54:	   
ifFileExists "$INSTDIR\Tirtagaine-KechtatIII.*k3" "Y55" "N55"
...
N55:	   
ifFileExists "$INSTDIR\Under_Siege.*k3" "Y56" "N56"
...
N56:	   
ifFileExists "$INSTDIR\V2Shelter.*k3" "Y57" "N57"
...
N57:	   
ifFileExists "$INSTDIR\User-finalv3lab.*k3" "Y58" "N58"
...
N58:	   
ifFileExists "$INSTDIR\wuesten-kaff-beta9.*k3" "Y59" "N59"
...
N59:	   
ifFileExists "$INSTDIR\user-ydiss-xfire.*k3" "Y60" "N60"
...
N60:	   
ifFileExists "$INSTDIR\africannightstdm.*k3" "Y61" "N61"
...
N61:	   
ifFileExists "$INSTDIR\ammo_factory.*k3" "Y62" "N62"
...
N62:	   
ifFileExists "$INSTDIR\Arnhem.*k3" "Y63" "N63"
...
N63:	   
ifFileExists "$INSTDIR\bob_carentan.*k3" "Y64" "N64"
...
N64:	   
ifFileExists "$INSTDIR\Map_AA_bombedv.*k3" "Y65" "N65"
...
N65:	   
ifFileExists "$INSTDIR\User-Broken_Silence.*k3" "Y66" "N66"
...
N66:	   
ifFileExists "$INSTDIR\BSunrise3-3.*k3" "Y67" "N67"
...
N67:	   
ifFileExists "$INSTDIR\bullettrain.*k3" "Y68" "N68"
...
N68:	   
ifFileExists "$INSTDIR\AR_Bunkeranlage_V1.*k3" "Y69" "N69"
...
!insertmacro NSISDLSMOOTH_DOWNLOAD "http://www.dog-cie.com/Ultime_Pack_Maps_DMW/Download/dl.php?id=Opra" "$INSTDIR\[OBJ] Opera House"

rename "$INSTDIR\[OBJ] Opera House" "$INSTDIR\Opra.pk3"
...
!insertmacro NSISDLSMOOTH_DOWNLOAD "http://www.dog-cie.com/Ultime_Pack_Maps_DMW/Download/dl.php?id=user-ydiss-xfire" "$INSTDIR\[OBJ] Xfire"
...
!insertmacro NSISDLSMOOTH_DOWNLOAD "http://www.dog-cie.com/Ultime_Pack_Maps_DMW/Download/dl.php?id=Obj_TheChurch_Final" "$INSTDIR\[TDM] The Church Final"
...
!insertmacro NSISDLSMOOTH_DOWNLOAD "http://www.dog-cie.com/Ultime_Pack_Maps_DMW/Download/dl.php?id=user-ydiss-objxfireville" "$INSTDIR\[TDM] Xfire ville"
